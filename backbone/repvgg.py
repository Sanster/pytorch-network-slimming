...
class RepVGGBlock(nn.Module):
    def __init__(
        ...
        if deploy:
            ...
            if out_channels == in_channels and stride == 1 and add_identity:
...
def create_RepVGG_A0_woid(deploy=False, num_classes=10):
    return RepVGG(
        num_blocks=[2, 4, 14, 1],
        num_classes=num_classes,
        width_multiplier=[0.75, 0.75, 0.75, 2.5],
...
def create_RepVGG_B2_woid(deploy=False, num_classes=10):
    return RepVGG(
        num_blocks=[4, 6, 16, 1],
        num_classes=num_classes,
        width_multiplier=[2.5, 2.5, 2.5, 5],
...
def create_RepVGG_B2g2_woid(deploy=False, num_classes=10):
    return RepVGG(
        num_blocks=[4, 6, 16, 1],
        num_classes=num_classes,
        width_multiplier=[2.5, 2.5, 2.5, 5],
...
def create_RepVGG_B3_woid(deploy=False, num_classes=10):
    return RepVGG(
        num_blocks=[4, 6, 16, 1],
        num_classes=num_classes,
        width_multiplier=[2.5, 2.5, 2.5, 5],
...
func_dict = {
    ...
    "RepVGG-A0-woid": create_RepVGG_A0_woid,
    "RepVGG-B2-woid": create_RepVGG_B2_woid,
    "RepVGG-B3-woid": create_RepVGG_B3_woid,
    "RepVGG-B2g2-woid": create_RepVGG_B2g2_woid,
}
