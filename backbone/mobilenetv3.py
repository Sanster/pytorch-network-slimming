...
def _mobilenet_v3_conf(arch: str, params: Dict[str, Any], no_se: bool = False):
    ...
    if arch == "mobilenet_v3_large":
        inverted_residual_setting = [
            ...
            # cifar10: stride 2 -> 1
            bneck_conf(16, 3, 64, 24, False, "RE", 1, 1),  # C1
    ...
    if no_se:
        for it in inverted_residual_setting:
            it.use_se = False
...
def mobilenet_v3_large(
    pretrained: bool = False, progress: bool = True, no_se: bool = False, **kwargs: Any
) -> MobileNetV3:
    """
